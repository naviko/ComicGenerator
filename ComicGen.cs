...
{
    internal class ComicGen
    {
        private Random m_rand;

        public class Message
        {
            public Message(string a_user, string a_text)
            {
                User = a_user;
                Text = a_text;
            }
        ...
        private List<PanelDef> LoadPanels(string a_path)
        {
        ...
        private List<Panel> GeneratePanels(Random a_rand, List<PanelDef> a_panelDefs, List<Message> a_messages)
        {
        ...
        private readonly int spacing = 16;
        private readonly int panWidth = 256;
        private readonly int panHeight = 192;

        private Bitmap GenerateComic(Random a_rand, List<Panel> a_panels)
        {
            ...
            using (Graphics g = Graphics.FromImage(bmp))
            {
                ...
                var userColours = new Dictionary<string, Color>();
        ...
        private void DrawPanel(Graphics a_g, Bitmap a_panel, Point a_pos, int a_borderWidth)
        {
